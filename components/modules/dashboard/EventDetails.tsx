    ...
    <div className="flex min-h-screen flex-1 flex-col px-6 py-36 max-md:pb-14 sm:px-14 max-w-5xl mx-auto ">
      <div className="mx-auto px-4 py-8 w-full">
        <div className="max-w-5xl mx-auto">
          ...
          <Link href="/" className="inline-block mb-6"></Link>
          <div className="w-full h-[40vh] bg-green-500 rounded-lg mb-8"></div>
          <div className="flex items-center mb-8 w-full">
            <div className="flex flex-col items-center w-full">
              <h1 className="h1-bold primary-text-gradient">{title}</h1>
              <p className="text-dark400_light900">{description}</p>
            </div>
          </div>
            ...
            <CardContent className="text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Button
                  ...
                  variant="default"
                  className="flex-1 outline primary-gradient hover:shadow-[0_0_4px_1px_rgba(245,158,11,0.6)] dark:hover:shadow-[0_0_15px_2px_rgba(245,158,11,0.7)] transition duration-300 ease-in-out cursor-pointer"
                  disabled={isExpired}
                >
