...
const PriceSection = () => {
  ...
  return (
    <section className="py-20 background-light850_dark100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-14 lg:gap-8 max-w-6xl mx-auto p-6">
        {prices.map((price, index) => (
          <Card
            key={index}
            className={`card-wrapper  md:max-w-[350px]  relative ${
            ...
            <CardContent className="space-y-6">
              ...
              <div className="pt-4 space-y-3">
                ...
                <p className="text-xs text-dark500_light400 max-w-6xl mx-auto mt-6">
                  ...
                  compression for videos to keep costs down. If you expect heavy
                  video usage, contact sales for a custom Enterprise quote.
                </p>
              </div>
            </CardContent>
          </Card>
